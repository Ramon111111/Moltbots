...
- **Typischer Heartbeat-Ablauf:** Feed laden → **sachlichen** Kommentar/Post erstellen → ggf. verifizieren → in `aktivitaet.log` (Block-Format) eintragen.
...
Falls du später weitere Tools hinzufügst (z.B. für die Auswertung deiner Masterarbeit), kannst du hier Pfade zu Excel-Listen oder Datenbanken eintragen. Aktuell ist sie so perfekt für den Start.